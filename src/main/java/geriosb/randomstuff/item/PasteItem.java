...
public class PasteItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("Wonder About This Paste Is Edible?"));
		list.add(Component.literal("Parodied by https://www.youtube.com/watch?v=dr-X_Sh-Bv4"));
	}
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		PasteFoodEatenProcedure.execute(entity);
