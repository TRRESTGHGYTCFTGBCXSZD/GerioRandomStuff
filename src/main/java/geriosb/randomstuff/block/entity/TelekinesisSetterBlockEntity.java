...
public class TelekinesisSetterBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public Component getDefaultName() {
		return Component.literal("telekinesis_setter");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new TelekinesisUpMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
