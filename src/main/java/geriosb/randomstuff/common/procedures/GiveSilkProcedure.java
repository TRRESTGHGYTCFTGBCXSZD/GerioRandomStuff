...
public class GiveSilkProcedure {
	public static void execute(Entity entity) {
		...
		(entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get() instanceof Map _slt ? ((Slot) _slt.get(0)).getItem() : ItemStack.EMPTY).enchant(Enchantments.SILK_TOUCH, 16);
	}
}
