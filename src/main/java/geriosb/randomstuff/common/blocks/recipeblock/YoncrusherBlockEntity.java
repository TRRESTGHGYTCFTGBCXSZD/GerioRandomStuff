package geriosb.randomstuff.common.blocks.recipeblock;
...
public class YoncrusherBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public Component getDefaultName() {
		return Component.literal("yoncrusher");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new YoncrushMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}

	@Override
	public Component getDisplayName() {
		return Component.literal("Yoncrusher (WIP)");
	}
	...
	private final EnergyStorage energyStorage = new EnergyStorage(160000, 160000, 0, 0) {
		@Override
