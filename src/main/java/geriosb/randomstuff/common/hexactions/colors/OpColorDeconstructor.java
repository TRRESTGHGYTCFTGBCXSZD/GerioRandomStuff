...
public final class OpColorDeconstructor implements ConstMediaAction { //why kotlin why
    public static final OpColorDeconstructor INSTANCE;

    static {
        OpColorDeconstructor var0 = new OpColorDeconstructor();
        INSTANCE = var0;
    }
    ...
    public @NotNull List<Iota> execute(@NotNull List<? extends Iota> list, @NotNull CastingEnvironment castingEnvironment) throws Mishap {
        ...
        if (args1 instanceof ColorIota Colore) {
            ...
            FUCK.add(new DoubleIota((Colore.getColor()&0xff000000)>>24));
