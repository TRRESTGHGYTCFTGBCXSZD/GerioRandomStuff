package geriosb.randomstuff.common.hexactions.colors;
...
public final class OpColorConstructor implements ConstMediaAction { //why kotlin why
    public static final OpColorConstructor INSTANCE;

    static {
        OpColorConstructor var0 = new OpColorConstructor();
        INSTANCE = var0;
    }
    ...
    public @NotNull List<Iota> execute(@NotNull List<? extends Iota> list, @NotNull CastingEnvironment castingEnvironment) throws Mishap {
        ...
        Iota args2 = list.get(1);
        Iota args3 = list.get(2);
        Iota args4 = list.get(3);
        if (args1 instanceof DoubleIota Colora) {
            if (args2 instanceof DoubleIota Colorr) {
                if (args3 instanceof DoubleIota Colorg) {
                    if (args4 instanceof DoubleIota Colorb) {
                        ...
                        int alpha = (int) Colora.getDouble() & 0xff;
            ...
            throw new MishapInvalidIota(args1,0,Component.translatable("number"));
        }
    }
