...
public class GeriorandomstuffModBlockEntities {
	...
	public static final RegistryObject<BlockEntityType<?>> MEGA_STORAGE = register("mega_storage", GeriorandomstuffModBlocks.MEGA_STORAGE, MegaStorageBlockEntity::new);
