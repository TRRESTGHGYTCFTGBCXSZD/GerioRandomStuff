...
import geriosb.randomstuff.item.SuperSlateItemItem;
...
public class GeriorandomstuffModItems {
	...
	public static final RegistryObject<Item> INSTANT_ITEM_PIPE = block(GeriorandomstuffModBlocks.INSTANT_ITEM_PIPE);
	public static final RegistryObject<Item> INSTANT_LIQUID_PIPE = block(GeriorandomstuffModBlocks.INSTANT_LIQUID_PIPE);
	...
	public static final RegistryObject<Item> INSTANT_GAS_PIPE = block(GeriorandomstuffModBlocks.INSTANT_GAS_PIPE);
	public static final RegistryObject<Item> MEGA_STORAGE = block(GeriorandomstuffModBlocks.MEGA_STORAGE);
	public static final RegistryObject<Item> GERIO_BLOCK = block(GeriorandomstuffModBlocks.GERIO_BLOCK);
	public static final RegistryObject<Item> SUPER_SLATE = block(GeriorandomstuffModBlocks.SUPER_SLATE);
	public static final RegistryObject<Item> SUPER_SLATE_ITEM = REGISTRY.register("super_slate_item", () -> new SuperSlateItemItem());
